// Задача 54: Задайте двумерный массив. Напишите программу, которая упорядочит по убыванию элементы каждойстроки двумерного массива.
...
int n = GetNum("Количество строк массива: ");
int m = GetNum("Количество столбцов массива: ");
